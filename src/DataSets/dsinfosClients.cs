...
namespace Transacts {
    ...
    public class dsinfosClients : DataSet {
        
        private ClientDataTable tableClient;
        
        public dsinfosClients() {
            this.InitClass();
        ...
        protected dsinfosClients(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsinfosClients cln = ((dsinfosClients)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsinfosClients";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsinfosClients.xsd";
        ...
        public class ClientDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public ClientRow AddClientRow(int NumClient, string NomClient, string PrenomClient, int NumCompteJournalier) {
