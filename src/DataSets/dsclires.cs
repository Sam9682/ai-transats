...
namespace Transacts {
    ...
    public class dsclires : DataSet {
        ...
        protected dsclires(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsclires cln = ((dsclires)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsclires";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsclires.xsd";
        ...
        public class ClientDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public ClientRow AddClientRow(string NomClient, int NumClient, string PrenomClient) {
