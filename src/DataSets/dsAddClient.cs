...
namespace Transacts {
    ...
    public class dsAddClient : DataSet {
        ...
        protected dsAddClient(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsAddClient cln = ((dsAddClient)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsAddClient";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsAddClient.xsd";
