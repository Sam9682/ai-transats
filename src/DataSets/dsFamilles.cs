...
namespace Transacts {
    ...
    public class dsFamilles : DataSet {
        ...
        protected dsFamilles(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            dsFamilles cln = ((dsFamilles)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "dsFamilles";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/dsFamilles.xsd";
