...
{
	/// <summary>
	/// Summary description for NouvelleReservation.
	/// </summary>
	public class NouvelleReservation : System.Windows.Forms.Form
	{
		...
		private Transacts.dsclires dsclires1;
		...
		private void InitializeComponent()
		{
			...
			this.dsclires1 = new Transacts.dsclires();
			...
			((System.ComponentModel.ISupportInitialize)(this.dsclires1)).BeginInit();
			...
			this.label1.Location = new System.Drawing.Point(464, 264);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(151, 19);
			this.label1.TabIndex = 8;
			this.label1.Text = "Heure Arrivée prévue";
			// 
			// numericUpDown1
			// 
			this.numericUpDown1.Font = new System.Drawing.Font("Tahoma", 15F);
			this.numericUpDown1.Location = new System.Drawing.Point(176, 144);
			...
			// dateTimePicker1
			// 
			this.dateTimePicker1.Font = new System.Drawing.Font("Palatino Linotype", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.dateTimePicker1.Format = System.Windows.Forms.DateTimePickerFormat.Time;
			this.dateTimePicker1.Location = new System.Drawing.Point(480, 288);
			...
			// oleDbSelectCommand1
			// 
			this.oleDbSelectCommand1.CommandText = "SELECT NomClient, NumClient, PrenomClient FROM Client";
			this.oleDbSelectCommand1.Connection = this.oleDbConnection1;
			// 
			// oleDbInsertCommand1
			// 
			this.oleDbInsertCommand1.CommandText = "INSERT INTO Client(NomClient, NumClient, PrenomClient) VALUES (?, ?, ?)";
			...
			// oleDbUpdateCommand1
			// 
			this.oleDbUpdateCommand1.CommandText = "UPDATE Client SET NomClient = ?, NumClient = ?, PrenomClient = ? WHERE (NumClient" +
				" = ?) AND (NomClient = ? OR ? IS NULL AND NomClient IS NULL) AND (PrenomClient =" +
				" ? OR ? IS NULL AND PrenomClient IS NULL)";
			...
			// oleDbDeleteCommand1
			// 
			this.oleDbDeleteCommand1.CommandText = "DELETE FROM Client WHERE (NumClient = ?) AND (NomClient = ? OR ? IS NULL AND NomC" +
				"lient IS NULL) AND (PrenomClient = ? OR ? IS NULL AND PrenomClient IS NULL)";
			...
			// dsclires1
			// 
			this.dsclires1.DataSetName = "dsclires";
			this.dsclires1.Locale = new System.Globalization.CultureInfo("fr-FR");
			this.dsclires1.Namespace = "http://www.tempuri.org/dsclires.xsd";
			// 
			// label5
			// 
			...
			// txtNomClient
			// 
			this.txtNomClient.Font = new System.Drawing.Font("Tahoma", 11.25F);
			this.txtNomClient.Location = new System.Drawing.Point(72, 80);
			this.txtNomClient.Name = "txtNomClient";
			this.txtNomClient.Size = new System.Drawing.Size(224, 26);
			this.txtNomClient.TabIndex = 106;
			this.txtNomClient.Text = "";
			this.txtNomClient.TextChanged += new System.EventHandler(this.textBox1_TextChanged);
			...
			// txtPrenomClient
			// 
			this.txtPrenomClient.Font = new System.Drawing.Font("Tahoma", 11.25F);
			this.txtPrenomClient.Location = new System.Drawing.Point(72, 112);
			this.txtPrenomClient.Name = "txtPrenomClient";
			this.txtPrenomClient.Size = new System.Drawing.Size(224, 26);
			this.txtPrenomClient.TabIndex = 109;
			this.txtPrenomClient.Text = "";
			this.txtPrenomClient.TextChanged += new System.EventHandler(this.txtPrenomClient_TextChanged);
			this.txtPrenomClient.Enter += new System.EventHandler(this.txtPrenomClient_Enter);
			// 
			// txtCode
			// 
			this.txtCode.Font = new System.Drawing.Font("Tahoma", 11.25F);
			this.txtCode.Location = new System.Drawing.Point(72, 48);
			this.txtCode.Name = "txtCode";
			this.txtCode.Size = new System.Drawing.Size(224, 26);
			...
			this.label7.Text = "Informations  Client";
			// 
			// label6
			// 
			...
			this.tabControl1.Location = new System.Drawing.Point(8, 280);
			...
			this.tabPage1.Size = new System.Drawing.Size(432, 178);
			...
			this.button39.Location = new System.Drawing.Point(232, 8);
			...
			this.button30.Location = new System.Drawing.Point(176, 120);
			...
			this.button31.Location = new System.Drawing.Point(120, 120);
			...
			this.button32.Location = new System.Drawing.Point(64, 120);
			...
			this.button33.Location = new System.Drawing.Point(176, 64);
			...
			this.button34.Location = new System.Drawing.Point(120, 64);
			...
			this.button35.Location = new System.Drawing.Point(64, 64);
			...
			this.button36.Location = new System.Drawing.Point(176, 8);
			...
			this.button37.Location = new System.Drawing.Point(120, 8);
			...
			this.button38.Location = new System.Drawing.Point(64, 8);
			...
			this.button21.Location = new System.Drawing.Point(256, 88);
			...
			this.button40.Click += new System.EventHandler(this.button39_Click);
			// 
			// button41
			// 
			this.button41.BackColor = System.Drawing.Color.Cornsilk;
			this.button41.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.button41.Font = new System.Drawing.Font("Courier New", 18F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.button41.Location = new System.Drawing.Point(320, 8);
			this.button41.Name = "button41";
			this.button41.Size = new System.Drawing.Size(80, 40);
			this.button41.TabIndex = 121;
			this.button41.Text = "EFF";
			...
			this.label8.Text = "Selectionner la date de réservation";
			...
			this.monthCalendar1.Location = new System.Drawing.Point(344, 32);
			...
			this.button2.Location = new System.Drawing.Point(456, 384);
			...
			this.Load += new System.EventHandler(this.NouvelleReservation_Load);
			((System.ComponentModel.ISupportInitialize)(this.numericUpDown1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dsclires1)).EndInit();
		...
		{
			NumClient=txtCode.Text;
			DateRes=monthCalendar1.SelectionStart.ToShortDateString()+" "+dateTimePicker1.Value.ToShortTimeString();
			reserver =true;
			this.Close();
		}

		private void NouvelleReservation_Load(object sender, System.EventArgs e)
		{
			oleDbDataAdapter1.Fill(dsclires1);
		}
		int ControlSelected = 2;
		...
		{
			for(int i=0;i<dsclires1.Tables[0].Rows.Count;i++)
			 if(dsclires1.Tables[0].Rows[i].ItemArray[0].ToString()==txtNomClient.Text)
			 {
				 txtCode.Text=dsclires1.Tables[0].Rows[i].ItemArray[1].ToString();
				 txtPrenomClient.Text=dsclires1.Tables[0].Rows[i].ItemArray[2].ToString();
			 }
		}
		...
		{
			for(int i=0;i<dsclires1.Tables[0].Rows.Count;i++)
				if(dsclires1.Tables[0].Rows[i].ItemArray[1].ToString()==txtCode.Text)
				{
					txtNomClient.Text=dsclires1.Tables[0].Rows[i].ItemArray[0].ToString();
					txtPrenomClient.Text=dsclires1.Tables[0].Rows[i].ItemArray[2].ToString();
				}
		}

		private void txtPrenomClient_TextChanged(object sender, System.EventArgs e)
		{
			for(int i=0;i<dsclires1.Tables[0].Rows.Count;i++)
				if(dsclires1.Tables[0].Rows[i].ItemArray[2].ToString()==txtPrenomClient.Text)
				{
					txtNomClient.Text=dsclires1.Tables[0].Rows[i].ItemArray[0].ToString();
					txtCode.Text=dsclires1.Tables[0].Rows[i].ItemArray[1].ToString();
				}
		...
		{if (ControlSelected==1)
			txtCode.Text+=sender.ToString().Substring(sender.ToString().Length-1,1);
		if (ControlSelected==2)
				txtNomClient.Text +=sender.ToString().Substring(sender.ToString().Length-1,1);
		if (ControlSelected==3)
				txtPrenomClient.Text +=sender.ToString().Substring(sender.ToString().Length-1,1);
		}
		...
		private void txtNomClient_Enter(object sender, System.EventArgs e)
		{
			ControlSelected=2;
		}

		private void txtPrenomClient_Enter(object sender, System.EventArgs e)
		{
			ControlSelected=3;
		}
