...
{
	/// <summary>
	/// Summary description for AjoutEmploye.
	/// </summary>
	public class AjoutEmploye : System.Windows.Forms.Form
	{
		...
		private Transacts.dsEmployes dsEmployes1;
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.dsEmployes1 = new Transacts.dsEmployes();
			this.tabControl1.SuspendLayout();
			this.tabPage1.SuspendLayout();
			this.tabPage2.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dsEmployes1)).BeginInit();
			this.SuspendLayout();
			// 
			// button43
			// 
			...
			this.button43.Location = new System.Drawing.Point(320, 128);
			...
			this.button41.Location = new System.Drawing.Point(320, 72);
			...
			this.textBox6.Location = new System.Drawing.Point(112, 184);
			...
			this.tabControl1.Location = new System.Drawing.Point(8, 352);
			...
			// label8
			// 
			this.label8.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.label8.Location = new System.Drawing.Point(24, 232);
			this.label8.Name = "label8";
			this.label8.Size = new System.Drawing.Size(64, 40);
			this.label8.TabIndex = 124;
			this.label8.Text = "Salaire mensuel";
			// 
			// textBox7
			// 
			this.textBox7.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.textBox7.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.textBox7.Location = new System.Drawing.Point(112, 240);
			this.textBox7.Name = "textBox7";
			this.textBox7.Size = new System.Drawing.Size(88, 26);
			...
			// label9
			// 
			this.label9.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.label9.Location = new System.Drawing.Point(232, 240);
			this.label9.Name = "label9";
			this.label9.Size = new System.Drawing.Size(104, 24);
			this.label9.TabIndex = 125;
			this.label9.Text = "Poste Courant";
			// 
			// comboBox1
			// 
			...
			this.comboBox1.Items.AddRange(new object[] {
														   ...
														   "Boutique",
														   ""});
			this.comboBox1.Location = new System.Drawing.Point(344, 240);
			...
			// label10
			// 
			this.label10.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.textBox8.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.textBox8.Location = new System.Drawing.Point(112, 144);
			...
			// label11
			// 
			this.label11.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.textBox9.Font = new System.Drawing.Font("Tahoma", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.textBox9.Location = new System.Drawing.Point(200, 272);
			...
			this.oleDbDataAdapter1.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
																										new System.Data.Common.DataTableMapping("Table", "Employe", new System.Data.Common.DataColumnMapping[] {
																																																				   ...
																																																				   new System.Data.Common.DataColumnMapping("NomEmploye", "NomEmploye"),
																																																				   new System.Data.Common.DataColumnMapping("PrenomEmploye", "PrenomEmploye"),
																																																				   new System.Data.Common.DataColumnMapping("Salaire", "Salaire"),
																																																				   new System.Data.Common.DataColumnMapping("TelEmploye", "TelEmploye"),
																																																				   new System.Data.Common.DataColumnMapping("poste", "poste"),
																																																				   new System.Data.Common.DataColumnMapping("motdePasse", "motdePasse"),
																																																				   new System.Data.Common.DataColumnMapping("Alias", "Alias"),
																																																				   new System.Data.Common.DataColumnMapping("AdresseEmploye", "AdresseEmploye")})});
			this.oleDbDataAdapter1.UpdateCommand = this.oleDbUpdateCommand1;
			// 
			// oleDbDeleteCommand1
			// 
			this.oleDbDeleteCommand1.CommandText = @"DELETE FROM Employe WHERE (NumEmploye = ?) AND (AdresseEmploye = ? OR ? IS NULL AND AdresseEmploye IS NULL) AND (Alias = ? OR ? IS NULL AND Alias IS NULL) AND (NomEmploye = ? OR ? IS NULL AND NomEmploye IS NULL) AND (PrenomEmploye = ? OR ? IS NULL AND PrenomEmploye IS NULL) AND (Salaire = ? OR ? IS NULL AND Salaire IS NULL) AND (TelEmploye = ? OR ? IS NULL AND TelEmploye IS NULL) AND (motdePasse = ? OR ? IS NULL AND motdePasse IS NULL) AND (poste = ? OR ? IS NULL AND poste IS NULL)";
			...
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_AdresseEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "AdresseEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_AdresseEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "AdresseEmploye", System.Data.DataRowVersion.Original, null));
			...
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_NomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "NomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_NomEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "NomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_PrenomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "PrenomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_PrenomEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "PrenomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Salaire", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Salaire", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Salaire1", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Salaire", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_TelEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "TelEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_TelEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "TelEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_motdePasse", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "motdePasse", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_motdePasse1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "motdePasse", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_poste", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "poste", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_poste1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "poste", System.Data.DataRowVersion.Original, null));
			// 
			// oleDbConnection1
			// 
			...
			// oleDbInsertCommand1
			// 
			this.oleDbInsertCommand1.CommandText = "INSERT INTO Employe(NumEmploye, NomEmploye, PrenomEmploye, Salaire, TelEmploye, p" +
				"oste, motdePasse, Alias, AdresseEmploye) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
			...
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("NomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "NomEmploye"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("PrenomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "PrenomEmploye"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Salaire", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Salaire", System.Data.DataRowVersion.Current, null));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("TelEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "TelEmploye"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("poste", System.Data.OleDb.OleDbType.VarWChar, 50, "poste"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("motdePasse", System.Data.OleDb.OleDbType.VarWChar, 50, "motdePasse"));
			...
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("AdresseEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "AdresseEmploye"));
			// 
			// oleDbSelectCommand1
			// 
			this.oleDbSelectCommand1.CommandText = "SELECT NumEmploye, NomEmploye, PrenomEmploye, Salaire, TelEmploye, poste, motdePa" +
				"sse, Alias, AdresseEmploye FROM Employe";
			this.oleDbSelectCommand1.Connection = this.oleDbConnection1;
			// 
			// oleDbUpdateCommand1
			// 
			this.oleDbUpdateCommand1.CommandText = @"UPDATE Employe SET NumEmploye = ?, NomEmploye = ?, PrenomEmploye = ?, Salaire = ?, TelEmploye = ?, poste = ?, motdePasse = ?, Alias = ?, AdresseEmploye = ? WHERE (NumEmploye = ?) AND (AdresseEmploye = ? OR ? IS NULL AND AdresseEmploye IS NULL) AND (Alias = ? OR ? IS NULL AND Alias IS NULL) AND (NomEmploye = ? OR ? IS NULL AND NomEmploye IS NULL) AND (PrenomEmploye = ? OR ? IS NULL AND PrenomEmploye IS NULL) AND (Salaire = ? OR ? IS NULL AND Salaire IS NULL) AND (TelEmploye = ? OR ? IS NULL AND TelEmploye IS NULL) AND (motdePasse = ? OR ? IS NULL AND motdePasse IS NULL) AND (poste = ? OR ? IS NULL AND poste IS NULL)";
			...
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("NomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "NomEmploye"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("PrenomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "PrenomEmploye"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Salaire", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Salaire", System.Data.DataRowVersion.Current, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("TelEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "TelEmploye"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("poste", System.Data.OleDb.OleDbType.VarWChar, 50, "poste"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("motdePasse", System.Data.OleDb.OleDbType.VarWChar, 50, "motdePasse"));
			...
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("AdresseEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, "AdresseEmploye"));
			...
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_AdresseEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "AdresseEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_AdresseEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "AdresseEmploye", System.Data.DataRowVersion.Original, null));
			...
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_NomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "NomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_NomEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "NomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_PrenomEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "PrenomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_PrenomEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "PrenomEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Salaire", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Salaire", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Salaire1", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Salaire", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_TelEmploye", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "TelEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_TelEmploye1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "TelEmploye", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_motdePasse", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "motdePasse", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_motdePasse1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "motdePasse", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_poste", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "poste", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_poste1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "poste", System.Data.DataRowVersion.Original, null));
			// 
			// dsEmployes1
			// 
			this.dsEmployes1.DataSetName = "dsEmployes";
			this.dsEmployes1.Locale = new System.Globalization.CultureInfo("fr-FR");
			this.dsEmployes1.Namespace = "http://www.tempuri.org/dsEmployes.xsd";
			// 
			// AjoutEmploye
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.dsEmployes1)).EndInit();
		...
		private void button41_Click(object sender, System.EventArgs e)
		{
			...
			if (textBox5.Text==textBox9.Text)
			{
				try
				{
					conn.Open();
				...
				try
				{if(Exist == false)
					STRSQL="Insert into Employe(NumEmploye,NomEmploye,PrenomEmploye,AdresseEmploye,TelEmploye,Salaire,poste,motdepasse,alias) "+ 
						"values ("+
						...
						"'"+textBox6.Text+"',"+
						"'"+textBox4.Text+"',"+
						System.Convert.ToDouble(textBox7.Text.Replace(".",",")).ToString().Replace(",",".")+
						",'"+comboBox1.Text+"',"+
						"'"+textBox9.Text+"',"+
						"'"+textBox8.Text+"'"+
						" )";
					 ...
					 STRSQL="Update Employe set "+ 
						 "NomEmploye='"+textBox2.Text+"',"+
						 "PrenomEmploye='"+textBox3.Text+"',"+
						 "AdresseEmploye='"+textBox6.Text+"',"+
						 "TelEmploye='"+textBox4.Text+"',"+
						 "Salaire="+System.Convert.ToDouble(textBox7.Text.Replace(".",",")).ToString().Replace(",",".")+
						 ",poste='"+comboBox1.Text+"',"+
						 "motdepasse='"+textBox9.Text+"',"+
						 "alias='"+textBox8.Text+"'"+
						 " where NumEmploye="+System.Convert.ToInt64(textBox1.Text)+";";
		...
		{if(textBox7.Text!="")
			try
			{
				System.Convert.ToDouble(textBox7.Text.Replace(".",","));
			}							 
			catch(Exception exc){
		...
		private void textBox1_TextChanged(object sender, System.EventArgs e)
		{
			oleDbDataAdapter1.SelectCommand.CommandText=
				"Select * from Employe where NumEmploye ="+textBox1.Text;
			try
			{	
				dsEmployes1.Clear();
				oleDbDataAdapter1.Fill(dsEmployes1);
				if (dsEmployes1.Tables[0].Rows.Count>0) Exist=true;
				else Exist=false;
				textBox2.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[1].ToString();
				textBox3.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[2].ToString();
				textBox4.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[4].ToString();
				textBox5.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[6].ToString();
				textBox9.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[6].ToString();
				textBox6.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[8].ToString();
				textBox8.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[7].ToString();
				textBox7.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[3].ToString();
				comboBox1.Text=dsEmployes1.Tables[0].Rows[0].ItemArray[5].ToString();
