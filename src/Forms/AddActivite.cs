...
{
	/// <summary>
	/// Summary description for AddActivite.
	/// </summary>
	public class AddActivite : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.dateTimePicker2.Location = new System.Drawing.Point(96, 112);
			...
			this.dateTimePicker1.Location = new System.Drawing.Point(96, 80);
			...
			this.button43.Location = new System.Drawing.Point(352, 72);
			...
			this.button41.Location = new System.Drawing.Point(352, 16);
			this.button41.Name = "button41";
			this.button41.Size = new System.Drawing.Size(136, 48);
			this.button41.TabIndex = 136;
			...
			this.tabControl1.Location = new System.Drawing.Point(24, 272);
			...
			// numericUpDown1
			// 
			this.numericUpDown1.Font = new System.Drawing.Font("Microsoft Sans Serif", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.textBox3.Location = new System.Drawing.Point(96, 160);
			...
			this.oleDbDataAdapter1.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
																										new System.Data.Common.DataTableMapping("Table", "Activite", new System.Data.Common.DataColumnMapping[] {
																																																					new System.Data.Common.DataColumnMapping("CodeActivite", "CodeActivite"),
																																																					new System.Data.Common.DataColumnMapping("LibActivite", "LibActivite"),
																																																					new System.Data.Common.DataColumnMapping("Datedebut", "Datedebut"),
																																																					new System.Data.Common.DataColumnMapping("DateFin", "DateFin"),
																																																					new System.Data.Common.DataColumnMapping("NbPlaces", "NbPlaces"),
			...
			// oleDbSelectCommand1
			// 
			this.oleDbSelectCommand1.CommandText = "SELECT CodeActivite, Datedebut, DateFin, LibActivite, NbPlaces, Tarif FROM Activi" +
				"te";
			this.oleDbSelectCommand1.Connection = this.oleDbConnection1;
			// 
			// oleDbInsertCommand1
			// 
			this.oleDbInsertCommand1.CommandText = "INSERT INTO Activite(CodeActivite, Datedebut, DateFin, LibActivite, NbPlaces, Tar" +
				"if) VALUES (?, ?, ?, ?, ?, ?)";
			this.oleDbInsertCommand1.Connection = this.oleDbConnection1;
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("CodeActivite", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "CodeActivite", System.Data.DataRowVersion.Current, null));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Datedebut", System.Data.OleDb.OleDbType.DBDate, 0, "Datedebut"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("DateFin", System.Data.OleDb.OleDbType.DBDate, 0, "DateFin"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("LibActivite", System.Data.OleDb.OleDbType.VarWChar, 50, "LibActivite"));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("NbPlaces", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "NbPlaces", System.Data.DataRowVersion.Current, null));
			this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Tarif", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Tarif", System.Data.DataRowVersion.Current, null));
			// 
			// oleDbUpdateCommand1
			// 
			this.oleDbUpdateCommand1.CommandText = @"UPDATE Activite SET CodeActivite = ?, Datedebut = ?, DateFin = ?, LibActivite = ?, NbPlaces = ?, Tarif = ? WHERE (CodeActivite = ?) AND (DateFin = ? OR ? IS NULL AND DateFin IS NULL) AND (Datedebut = ? OR ? IS NULL AND Datedebut IS NULL) AND (LibActivite = ? OR ? IS NULL AND LibActivite IS NULL) AND (Tarif = ? OR ? IS NULL AND Tarif IS NULL)";
			this.oleDbUpdateCommand1.Connection = this.oleDbConnection1;
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("CodeActivite", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "CodeActivite", System.Data.DataRowVersion.Current, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Datedebut", System.Data.OleDb.OleDbType.DBDate, 0, "Datedebut"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("DateFin", System.Data.OleDb.OleDbType.DBDate, 0, "DateFin"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("LibActivite", System.Data.OleDb.OleDbType.VarWChar, 50, "LibActivite"));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("NbPlaces", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "NbPlaces", System.Data.DataRowVersion.Current, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Tarif", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Tarif", System.Data.DataRowVersion.Current, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_CodeActivite", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "CodeActivite", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_DateFin", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "DateFin", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_DateFin1", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "DateFin", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Datedebut", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "Datedebut", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Datedebut1", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "Datedebut", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_LibActivite", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "LibActivite", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_LibActivite1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "LibActivite", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Tarif", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Tarif", System.Data.DataRowVersion.Original, null));
			this.oleDbUpdateCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Tarif1", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Tarif", System.Data.DataRowVersion.Original, null));
			// 
			// oleDbDeleteCommand1
			// 
			this.oleDbDeleteCommand1.CommandText = @"DELETE FROM Activite WHERE (CodeActivite = ?) AND (DateFin = ? OR ? IS NULL AND DateFin IS NULL) AND (Datedebut = ? OR ? IS NULL AND Datedebut IS NULL) AND (LibActivite = ? OR ? IS NULL AND LibActivite IS NULL) AND (Tarif = ? OR ? IS NULL AND Tarif IS NULL)";
			this.oleDbDeleteCommand1.Connection = this.oleDbConnection1;
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_CodeActivite", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "CodeActivite", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_DateFin", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "DateFin", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_DateFin1", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "DateFin", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Datedebut", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "Datedebut", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Datedebut1", System.Data.OleDb.OleDbType.DBDate, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "Datedebut", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_LibActivite", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "LibActivite", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_LibActivite1", System.Data.OleDb.OleDbType.VarWChar, 50, System.Data.ParameterDirection.Input, false, ((System.Byte)(0)), ((System.Byte)(0)), "LibActivite", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Tarif", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Tarif", System.Data.DataRowVersion.Original, null));
			this.oleDbDeleteCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Original_Tarif1", System.Data.OleDb.OleDbType.Single, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(7)), ((System.Byte)(0)), "Tarif", System.Data.DataRowVersion.Original, null));
			// 
			// AddActivite
			// 
			...
			this.Controls.AddRange(new System.Windows.Forms.Control[] {
																		  ...
																		  this.textBox2,
																		  this.label1});
			this.Name = "AddActivite";
			this.Text = "AddActivite";
		...
		if(Exist==false)
		 {
			 ...
			 STRSQL = "INSERT INTO Activite VALUES ("+
				 " '"+textBox1.Text +"', "+
				 " '"+textBox2.Text +"', "+
			 ...
			 try 
			 {
				 ...
				 CommSQL = new OleDbCommand(STRSQL,oleDbDataAdapter1.SelectCommand.Connection);
		...
		{
			STRSQL = "UPDATE Activite set LibActivite="+
				" '"+textBox2.Text +"', Datedebut="+
				" '"+dateTimePicker1.Value.ToShortDateString()+"',DateFin= "+
				" '"+dateTimePicker2.Value.ToShortDateString()+
				"',NbPlaces='"+numericUpDown1.Value.ToString() +"',Tarif="+
				" '"+ textBox3.Text+"' where CodeActivite="+textBox1.Text;			
		...
		private void textBox1_TextChanged(object sender, System.EventArgs e)
		{
			...
			oleDbDataAdapter1.SelectCommand.CommandText=
				"SELECT * FROM ACTIVITE where CodeActivite ="+textBox1.Text; 
			try
			{
				...
				if (DS.Tables[0].Rows.Count>0)
				{
					...
					dateTimePicker1.Text=DS.Tables[0].Rows[0].ItemArray[2].ToString();
					dateTimePicker2.Text=DS.Tables[0].Rows[0].ItemArray[3].ToString();
					numericUpDown1.Value= System.Convert.ToInt32(DS.Tables[0].Rows[0].ItemArray[4].ToString());
					textBox3.Text= DS.Tables[0].Rows[0].ItemArray[5].ToString();
					Exist=true;
				}
			}
			catch (Exception exc){Exist= false;}
		}
	}
}
