...
namespace Transacts
{
    ...
    public static class ConsoleLogger
    {
            ...
            [CallerLineNumber] int lineNumber = 0)
        {
            ...
            ConsoleLogger.WriteLine($"[{timestamp}] [{fileName}:{lineNumber}] [{memberName}] {message}");
        }
            ...
            [CallerLineNumber] int lineNumber = 0)
        {
            ...
            ConsoleLogger.WriteLine($"[{timestamp}] [ERROR] [{fileName}:{lineNumber}] [{memberName}] {message}");
        }
            ...
            [CallerLineNumber] int lineNumber = 0)
        {
            ...
            ConsoleLogger.WriteLine($"[{timestamp}] [WARNING] [{fileName}:{lineNumber}] [{memberName}] {message}");
        }
            ...
            [CallerLineNumber] int lineNumber = 0)
        {
            ...
            ConsoleLogger.WriteLine($"[{timestamp}] [DEBUG] [{fileName}:{lineNumber}] [{memberName}] {message}");
        }
    }
}